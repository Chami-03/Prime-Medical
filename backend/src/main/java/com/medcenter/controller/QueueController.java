...
import com.medcenter.service.QueueService;
...
public class QueueController {
    ...
    public ResponseEntity<ApiResponse<QueueEntryResponse>> checkIn(
        ...
        QueueEntryResponse response = queueService.checkIn(request);
    ...
    @PreAuthorize("hasAnyRole('ADMIN','RECEPTIONIST','DOCTOR')")
    public ResponseEntity<ApiResponse<QueueEntryResponse>> markNoShow(@PathVariable Long id) {
        QueueEntryResponse response = queueService.markNoShow(id);
