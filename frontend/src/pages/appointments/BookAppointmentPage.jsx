...
import { Search, User, Calendar, Clock, ClipboardList, CheckCircle2 } from 'lucide-react'
        ...
        <div className="lg:col-span-8 space-y-4">
          ...
          <div className="pm-card p-5">
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-5">
              ...
              {!hasRole('DOCTOR') && (
                <select
                  className="form-input h-9 text-sm w-full sm:w-60"
              ...
              <input
                type="date"
                className="form-input h-9 text-sm w-full sm:w-44"
                value={selectedDate}
          ...
          <div className="pm-card p-5 sticky top-4">
            ...
            {(!selectedPatient || !selectedSlot) && (
              <p className="text-xs text-amber-600 mb-3">
                {!selectedPatient ? 'Select a patient' : ''}{!selectedPatient && !selectedSlot ? ' and ' : ''}{!selectedSlot ? 'select a time slot' : ''} to enable confirm booking.
              </p>
            )}

            <button
              disabled={!selectedPatient || !selectedSlot || bookMutation.isPending}
              onClick={handleBook}
